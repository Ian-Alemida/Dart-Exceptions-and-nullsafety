  ...
  bool makeTransfer(
    ...
    if (!accountSender.isAuthenticated) {
      throw SenderNotAuthenticatedException(
          idSender: idSender, authenticSender: accountSender.isAuthenticated);
    }

    // Verifica se o destinatario está autenticado
    if (!accountReceiver.isAuthenticated) {
      throw ReceiverNotAuthenticatedException(
          idReceiver: idReceiver,
          authenticReceiver: accountReceiver.isAuthenticated);
    }
